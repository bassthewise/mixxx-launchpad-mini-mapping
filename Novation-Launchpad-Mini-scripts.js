...
NLM.init = function()
{
        ...
        NLM.btns[NLM.page][8][0].setColor("hi_amber");
          ...
          // ============ CHANNEL 1 ==============
              ...
              // CUE btw
			  // NLM.setupBtn(page,1,1, Cue("Channel", deck));
              // PFL
          ...
          // =====================================
			  ...
			  deck = 1;
			  color = "lo_red";
              NLM.setupBtn(page,2,0, SeekKey(deck, 1, color));
              NLM.setupBtn(page,2,1, SeekKey(deck, 3, color));
              NLM.setupBtn(page,2,2, SeekKey(deck, 5, color));
              NLM.setupBtn(page,2,3, SeekKey(deck, 7, color));
              NLM.setupBtn(page,2,4, SeekKey(deck, 9, color));
              NLM.setupBtn(page,2,5, SeekKey(deck, 11, color));
              NLM.setupBtn(page,2,6, SeekKey(deck, 13, color));
              NLM.setupBtn(page,2,7, SeekKey(deck, 15, color));
          // ============ CHANNEL 1 ==============
            deck = 1;
            // VOLUME
          ...
          // =====================================
			  ...
			  deck = 2;
			  color = "lo_red";
              NLM.setupBtn(page,5,0, SeekKey(deck, 1, color));
              NLM.setupBtn(page,5,1, SeekKey(deck, 3, color));
              NLM.setupBtn(page,5,2, SeekKey(deck, 5, color));
              NLM.setupBtn(page,5,3, SeekKey(deck, 7, color));
              NLM.setupBtn(page,5,4, SeekKey(deck, 9, color));
              NLM.setupBtn(page,5,5, SeekKey(deck, 11, color));
              NLM.setupBtn(page,5,6, SeekKey(deck, 13, color));
              NLM.setupBtn(page,5,7, SeekKey(deck, 15, color));
        // ==========================================
          ...
          // ============ CHANNEL 2 ==============
            deck = 2;
              ...
              // CUE btw
			  // NLM.setupBtn(page,7,1, Cue("Channel", deck));
              // PFL
       ...
       // ================ PAGE H ==================
          ...
          // ============== CONTROLOS ===============
            ...
            // LOAD TRACK
            NLM.setupBtn(page,4,0, LoadKey("Channel",1, "hi_green", "hi_red"));
            NLM.setupBtn(page,5,0, LoadKey("Channel",2, "hi_red", "hi_red"));

            NLM.setupBtn(page,4,1, LoadKey2("Sampler",1, "hi_orange", "hi_green"));
            NLM.setupBtn(page,5,1, LoadKey2("Sampler",2, "hi_orange", "hi_green"));
            NLM.setupBtn(page,6,1, LoadKey2("Sampler",3, "hi_orange", "hi_green"));
            NLM.setupBtn(page,7,1, LoadKey2("Sampler",4, "hi_orange", "hi_green"));
			
            // AUTODJ
            NLM.setupBtn(page,4,2, PushKeyBinADJ("hi_yellow", "hi_amber", "[Library]", "AutoDjAddTop", 1));
            NLM.setupBtn(page,5,2, PushKeyBinADJ("hi_yellow", "hi_amber", "[Library]", "AutoDjAddBottom", 1));
            NLM.setupBtn(page,6,2, PushKeyBin("hi_green", "hi_green", "[AutoDJ]", "fade_now", 1));
            NLM.setupBtn(page,7,2, PushKeyBin("hi_red", "hi_amber", "[AutoDJ]", "skip_next", 1));
